...
2. Continue architecture A3-A4: improve diagnostics and remove editor database access. A1 shared canonical selection/row conversion and A2 transactional admin persistence are complete.
