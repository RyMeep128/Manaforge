...
2. Continue architecture A4: remove editor database access. Shared canonical selection/row conversion, transactional admin persistence, and background diagnostics (A1-A3) are complete.
